...
-- Đảm bảo có đủ khu vực để phân bổ camera và tài khoản
--
...
-- 4 camera cho mỗi khu vực, bao gồm cả camera hỏng để minh họa.
--
...
-- Mỗi camera sẽ có một số ảnh khác nhau để minh họa.
--
INSERT INTO Anh (IdCamera, DuongDan, KichThuoc) VALUES
(1, '/images/cam1_20250606_0800_1.jpg', 1.25), -- IdAnh = 1
(1, '/images/cam1_20250606_0805_2.jpg', 1.10), -- IdAnh = 2
(2, '/images/cam2_20250606_0810_1.jpg', 0.98), -- IdAnh = 3
(2, '/images/cam2_20250606_0815_2.jpg', 1.05), -- IdAnh = 4
(3, '/images/cam3_20250606_0820_1.jpg', 1.50), -- IdAnh = 5
(3, '/images/cam3_20250606_0825_2.jpg', 1.30), -- IdAnh = 6
(4, '/images/cam4_20250606_0830_1.jpg', 1.05), -- IdAnh = 7 (camera bị hỏng, có thể là ảnh trước đó)
(5, '/images/cam5_20250606_0835_1.jpg', 1.18), -- IdAnh = 8
(5, '/images/cam5_20250606_0840_2.jpg', 0.95), -- IdAnh = 9
(6, '/images/cam6_20250606_0845_1.jpg', 1.00), -- IdAnh = 10
(7, '/images/cam7_20250606_0850_1.jpg', 1.20), -- IdAnh = 11
(8, '/images/cam8_20250606_0855_1.jpg', 1.35), -- IdAnh = 12
(9, '/images/cam9_20250606_0900_1.jpg', 1.40), -- IdAnh = 13
(10, '/images/cam10_20250606_0905_1.jpg', 1.12), -- IdAnh = 14
(11, '/images/cam11_20250606_0910_1.jpg', 0.88), -- IdAnh = 15
(12, '/images/cam12_20250606_0915_1.jpg', 1.08), -- IdAnh = 16
(13, '/images/cam13_20250606_0920_1.jpg', 1.22), -- IdAnh = 17
(14, '/images/cam14_20250606_0925_1.jpg', 1.15), -- IdAnh = 18
(15, '/images/cam15_20250606_0930_1.jpg', 0.99), -- IdAnh = 19
(16, '/images/cam16_20250606_0935_1.jpg', 1.07); -- IdAnh = 20

--
-- Thêm dữ liệu vào bảng TaiKhoan (IdTaiKhoan sẽ là 1-10)
-- Các vai trò và khu vực khác nhau.
--
...
-- Các loại xe và màu sắc đa dạng.
--
...
-- Liên kết với Camera và Anh, thời gian đa dạng.
--
INSERT INTO NhanDangPhuongTien (IdPhuongTien, IdCamera, ThoiGian, IdAnh, ViTri, DoTinCay) VALUES
(1, 1, '2025-06-06 08:00:10', 1, 'Ngã tư Hàng Bài - Tràng Tiền', 0.95),
(2, 2, '2025-06-06 08:00:15', 3, 'Khu vực Hồ Gươm', 0.88),
(3, 3, '2025-06-06 08:00:20', 5, 'Quảng trường Ba Đình', 0.92),
(4, 5, '2025-06-06 08:00:25', 8, 'Ngã tư Thái Hà - Chùa Bộc', 0.85),
(5, 7, '2025-06-06 08:00:30', 11, 'Ngã tư Đại Cồ Việt - Trần Khát Chân', 0.90),
(6, 1, '2025-06-06 08:05:00', 2, 'Ngã tư Hàng Bài - Tràng Tiền', 0.93),
(7, 2, '2025-06-06 08:10:00', 4, 'Khu vực Hồ Gươm', 0.87),
(8, 3, '2025-06-06 08:15:00', 6, 'Quảng trường Ba Đình', 0.91),
(9, 8, '2025-06-06 08:20:00', 12, 'Khu vực Lăng Chủ tịch Hồ Chí Minh', 0.96),
(10, 10, '2025-06-06 08:25:00', 14, 'Khu vực Công viên Nước Hồ Tây', 0.89),
(11, 12, '2025-06-06 08:30:00', 16, 'Khu vực Đại học Quốc Gia Hà Nội', 0.94),
(12, 14, '2025-06-06 08:35:00', 18, 'Khu vực Royal City', 0.82),
(13, 16, '2025-06-06 08:40:00', 20, 'Khu vực Aeon Mall Long Biên', 0.97),
(14, 18, '2025-06-06 08:45:00', 19, 'Khu vực Bến xe Giáp Bát', 0.80),
(15, 20, '2025-06-06 08:50:00', 17, 'Khu vực Sân vận động Mỹ Đình', 0.90);

--
-- Thêm dữ liệu vào bảng DanhMucViPham (IdDanhMuc sẽ là 1-6)
-- Thêm một số loại vi phạm khác.
--
...
-- Liên kết các vi phạm với phương tiện, camera, ảnh và danh mục.
--
INSERT INTO PhatHienViPham (IdCamera, ThoiGian, ViTri, IdPhuongTien, IdDanhMuc, IdAnh, TrangThai) VALUES
(1, '2025-06-06 08:00:35', 'Ngã tư Hàng Bài - Tràng Tiền', 1, 1, 1, 'Chua Xu Ly'),
(2, '2025-06-06 08:00:40', 'Khu vực Hồ Gươm', 2, 2, 3, 'Da Xu Ly'),
(3, '2025-06-06 08:00:45', 'Quảng trường Ba Đình', 3, 3, 5, 'Chua Xu Ly'),
(5, '2025-06-06 08:00:50', 'Ngã tư Thái Hà - Chùa Bộc', 4, 1, 8, 'Chua Xu Ly'),
(7, '2025-06-06 08:00:55', 'Ngã tư Đại Cồ Việt - Trần Khát Chân', 5, 4, 11, 'Huy'),
(1, '2025-06-06 08:06:00', 'Phố Đinh Tiên Hoàng', 6, 5, 2, 'Chua Xu Ly'), -- Phương tiện 6 vi phạm
(2, '2025-06-06 08:11:00', 'Khu vực Hồ Gươm', 7, 6, 4, 'Da Xu Ly'),
(3, '2025-06-06 08:16:00', 'Quảng trường Ba Đình', 8, 1, 6, 'Chua Xu Ly'),
(8, '2025-06-06 08:21:00', 'Khu vực Lăng Chủ tịch Hồ Chí Minh', 9, 2, 12, 'Da Xu Ly'),
(10, '2025-06-06 08:26:00', 'Khu vực Công viên Nước Hồ Tây', 10, 3, 14, 'Chua Xu Ly'),
(12, '2025-06-06 08:31:00', 'Khu vực Đại học Quốc Gia Hà Nội', 11, 4, 16, 'Chua Xu Ly'),
(14, '2025-06-06 08:36:00', 'Khu vực Royal City', 12, 5, 18, 'Huy'),
(16, '2025-06-06 08:41:00', 'Khu vực Aeon Mall Long Biên', 13, 6, 20, 'Da Xu Ly'),
(18, '2025-06-06 08:46:00', 'Khu vực Bến xe Giáp Bát', 14, 1, 19, 'Chua Xu Ly'),
(20, '2025-06-06 08:51:00', 'Khu vực Sân vận động Mỹ Đình', 15, 2, 17, 'Chua Xu Ly');


--
-- Thêm dữ liệu vào bảng NhanDangNguoi (IdNhanDangNguoi tự tăng)
-- Đảm bảo dữ liệu `DacTrung` hợp lệ dưới dạng JSON_OBJECT.
--
-- INSERT INTO NhanDangNguoi (Tuoi, GioiTinh, DacTrung, IdAnh, IdCamera, ThoiGian, ViTri, DoTinCay) VALUES
-- (35, 'Nam', JSON_OBJECT('TrangPhuc', 'Áo khoác đen', 'PhuKien', 'Đeo kính râm', 'Toc', 'Ngắn', 'HinhDang', 'Cao gầy'), 1, 1, '2025-06-06 08:01:00', 'Khu vực Hồ Gươm', 0.92),
-- (28, 'Nu', JSON_OBJECT('TrangPhuc', 'Váy hoa', 'Toc', 'Tóc dài', 'PhuKien', 'Túi xách', 'HinhDang', 'Trung bình'), 2, 2, '2025-06-06 08:01:05', 'Đường Thanh Niên', 0.85),
-- (45, 'Nam', JSON_OBJECT('TrangPhuc', 'Áo sơ mi trắng', 'HinhDang', 'Dáng người cao to', 'PhuKien', 'Đồng hồ', 'Toc', 'Hói'), 3, 3, '2025-06-06 08:01:10', 'Quảng trường Ba Đình', 0.98),
-- (22, 'Nu', JSON_OBJECT('TrangPhuc', 'Quần jean áo phông', 'PhuKien', 'Balo', 'Toc', 'Tóc búi', 'HinhDang', 'Thon gọn'), 4, 2, '2025-06-06 08:01:15', 'Khu vực Hồ Gươm', 0.89),
-- (50, 'Nam', JSON_OBJECT('TrangPhuc', 'Áo vest', 'PhuKien', 'Cặp da', 'Toc', 'Bạc', 'HinhDang', 'Trung bình'), 5, 3, '2025-06-06 08:01:20', 'Quảng trường Ba Đình', 0.95),
-- (30, 'Nu', JSON_OBJECT('TrangPhuc', 'Đầm đỏ', 'PhuKien', 'Khuyên tai', 'Toc', 'Tóc xoăn', 'HinhDang', 'Đồng hồ cát'), 6, 3, '2025-06-06 08:01:25', 'Vincom Center Nguyễn Chí Thanh', 0.87),
-- (40, 'Nam', JSON_OBJECT('TrangPhuc', 'Quần short áo phông', 'PhuKien', 'Mũ lưỡi trai', 'Toc', 'Ngắn', 'HinhDang', 'Vạm vỡ'), 7, 4, '2025-06-06 08:01:30', 'Phố Tràng Tiền', 0.90), -- Camera 4 đang hỏng, đây có thể là dữ liệu cũ
-- (25, 'Nu', JSON_OBJECT('TrangPhuc', 'Áo hoodie', 'PhuKien', 'Tai nghe', 'Toc', 'Tóc nhuộm', 'HinhDang', 'Nhỏ nhắn'), 8, 5, '2025-06-06 08:01:35', 'Ngã tư Thái Hà - Chùa Bộc', 0.83),
-- (60, 'Nam', JSON_OBJECT('TrangPhuc', 'Áo ba lỗ', 'PhuKien', 'Kính lão', 'Toc', 'Hói', 'HinhDang', 'Gầy yếu'), 9, 5, '2025-06-06 08:01:40', 'Ngã tư Thái Hà - Chùa Bộc', 0.75),
-- (18, 'Nu', JSON_OBJECT('TrangPhuc', 'Đồng phục học sinh', 'PhuKien', 'Cặp sách', 'Toc', 'Tóc thẳng', 'HinhDang', 'Gầy'), 10, 6, '2025-06-06 08:01:45', 'Khu vực Đại học Quốc Gia Hà Nội', 0.94),
-- (32, 'Nam', JSON_OBJECT('TrangPhuc', 'Áo vest', 'PhuKien', 'Không có', 'Toc', 'Ngắn', 'HinhDang', 'Trung bình'), 11, 7, '2025-06-06 08:01:50', 'Ngã tư Đại Cồ Việt - Trần Khát Chân', 0.96),
-- (29, 'Nu', JSON_OBJECT('TrangPhuc', 'Áo len', 'PhuKien', 'Khăn quàng cổ', 'Toc', 'Tóc dài', 'HinhDang', 'Nhỏ nhắn'), 12, 8, '2025-06-06 08:01:55', 'Khu vực Lăng Chủ tịch Hồ Chí Minh', 0.88),
-- (48, 'Nam', JSON_OBJECT('TrangPhuc', 'Áo phông', 'PhuKien', 'Đồng hồ', 'Toc', 'Ngắn', 'HinhDang', 'Mập'), 13, 9, '2025-06-06 08:02:00', 'Ngã tư Giải Phóng - Vành đai 3', 0.91),
-- (20, 'Nu', JSON_OBJECT('TrangPhuc', 'Quần jean', 'PhuKien', 'Giày sneaker', 'Toc', 'Tóc xoăn', 'HinhDang', 'Cao'), 14, 10, '2025-06-06 08:02:05', 'Khu vực Sân vận động Mỹ Đình', 0.86),
-- (55, 'Nam', JSON_OBJECT('TrangPhuc', 'Áo khoác gió', 'PhuKien', 'Mũ len', 'Toc', 'Hói', 'HinhDang', 'Trung bình'), 15, 11, '2025-06-06 08:02:10', 'Ngã tư Xuân Thủy - Nguyễn Phong Sắc', 0.79);

--
-- Thêm dữ liệu vào bảng TinhTrangGiaoThong (IdTinhTrangGiaoThong tự tăng)
-- Minh họa các mức độ giao thông và tốc độ trung bình khác nhau.
--
INSERT INTO TinhTrangGiaoThong (IdCamera, ThoiGian, MatDoGiaoThong, TocDoTrungBinh) VALUES
(1, '2025-06-06 08:01:25', 'Thong Thoang', 45.5),
(2, '2025-06-06 08:01:30', 'Dong Duc', 25.0),
(3, '2025-06-06 08:01:35', 'Un Tac', 10.2),
(5, '2025-06-06 08:01:40', 'Thong Thoang', 52.1),
(7, '2025-06-06 08:01:45', 'Dong Duc', 30.8),
(1, '2025-06-06 08:05:00', 'Dong Duc', 28.5),
(2, '2025-06-06 08:10:00', 'Thong Thoang', 38.0),
(3, '2025-06-06 08:15:00', 'Un Tac', 15.0),
(8, '2025-06-06 08:20:00', 'Thong Thoang', 40.0),
(10, '2025-06-06 08:25:00', 'Dong Duc', 22.0),
(12, '2025-06-06 08:30:00', 'Thong Thoang', 35.0),
(14, '2025-06-06 08:35:00', 'Un Tac', 8.5),
(16, '2025-06-06 08:40:00', 'Dong Duc', 20.0),
(18, '2025-06-06 08:45:00', 'Thong Thoang', 48.0),
(20, '2025-06-06 08:50:00', 'Un Tac', 12.0);