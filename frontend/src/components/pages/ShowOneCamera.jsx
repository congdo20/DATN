        ...
        <div className="camera-video-container">
          {camera.IpCamera && camera.TrangThaiCamera === 'Hoat Dong' ? (
            ...
            <div style={{
              ...
              {camera.TrangThaiCamera === 'Hoat Dong' ? 'Không có stream' : `Camera hiện không hoạt động (${camera.TrangThaiCamera == "Hu Hong" ? "Hư Hỏng" : (camera.TrangThaiCamera == "Khong Hoat Dong" ? "Không Hoạt Động" : "Bảo Trì")})`}
            </div>
          )}
        </div>
